...
@section('nav-menu')
  ...
  <li class="active"><a href="{{url()}}/portofolio" id="link_navbar"><i class="fa fa-rocket fa-fw fa-lg"></i> Portofolio</a></li>
...
@section('folder')
  <div class="a">
     <ol class="breadcrumb" style="background-color:#bfbfbf;">
      ...
      <li class="active"><a href="{{url()}}/portofolio"><i class="fa fa-rocket fa-fw fa-lg"></i> Portofolio</a></li>
    </ol>
  </div>
@endsection
      ...
      <div class="col-md-8 col-md-push-4">
        <div class="panel panel-default" style="border:0px;">
          <div class="panel-heading">
            <h3><a href="{{url()}}/portofolio" style="color:#000;"><?php echo $menu_portofolio->jenis; ?></a></h3>
              <p><b><i class="fa fa-user fa-fw fa-lg"></i> <?php echo $menu_portofolio->user; ?></b></p>
              <p><b><i class="fa fa-calendar fa-fw fa-lg"></i> <?php echo $menu_portofolio->created_at->format('Y-m-d'); ?></b></p>
          </div>
          <div class="panel-body" style="padding:15px; font-size: 16px;">
              <?php echo $menu_portofolio->isi; ?>
          </div>
        </div>
      </div>
