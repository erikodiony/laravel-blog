...
@section('title')
<title>CCTVQu | Promo - <?php echo $show_byid_promo->judul; ?></title>
@endsection
...
@section('folder')
  <div class="a">
     <ol class="breadcrumb" style="background-color:#bfbfbf;">
      ...
      <li class="active"><a href="{{url()}}/promos/view?id={{$show_byid_promo->id}}"><i class="fa fa-pencil fa-fw fa-lg"></i> <?php echo $show_byid_promo->judul; ?></a></li>
    </ol>
  </div>
@endsection
      ...
      <div class="col-md-8 col-md-push-4">
        <div class="panel panel-default" style="border:0px;">
          <div class="panel-heading">
            <h3><a href="{{url()}}/promos/view?id={{$show_byid_promo->id}}" style="color:#000;"><?php echo $show_byid_promo->judul; ?></a></h3>
              <p><b><i class="fa fa-user fa-fw fa-lg"></i> <?php echo $show_byid_promo->user; ?></b></p>
              <p><b><i class="fa fa-calendar fa-fw fa-lg"></i> <?php echo $show_byid_promo->created_at->format('Y-m-d'); ?></b></p>
          </div>
          <div class="panel-body" style="padding:15px; font-size: 16px;">
              <?php echo $show_byid_promo->isi; ?>
          </div>
        </div>
      </div>
        ...
        <div class="panel panel-default" style="border:0px;">
          <div class="panel-body" style="padding:5px; font-size: 16px;">
            <ul class="nav nav-tabs">
            	<li class="active"><a href="#" data-toggle="tab" role="tab" data-target="#div-promo"><i class="fa fa-bullhorn fa-fw fa-lg"></i> Promo</a></li>
                <li><a href="#" data-toggle="tab" role="tab" data-target="#div-artikel"><i class="fa fa-newspaper-o fa-fw fa-lg"></i> Artikel</a></li>
            </ul>
