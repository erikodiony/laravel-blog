...
@section('folder')
  <div class="a">
     <ol class="breadcrumb" style="background-color:#bfbfbf;">
      ...
      <li class="active"><a href="{{url()}}/articles"><i class="fa fa-newspaper-o fa-fw fa-lg"></i> Artikel</a></li>
    </ol>
  </div>
@endsection
      ...
      <div class="panel-body" style="padding:5px; font-size: 16px;">
        <ul class="nav nav-tabs">
          ...
          <div class="tab-content">
            <div id="div-artikel" class="tab-pane fade in active" role="tabpanel" style="padding-top:20px; padding-bottom:20px;">
